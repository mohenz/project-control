...
## 진행 중 작업
- Jest 전환 또는 신규 도입 대상 프로젝트와 기능을 정해 `DEV_TS_0003` 결과서를 생성할 준비

## 최근 완료 작업
- 2026-06-27: JavaScript 프로젝트 테스트 표준으로 `docs/javascript_jest_playwright_standard.md` 추가. Jest 단위 테스트 준비 기준, 권장 스크립트, 기본 설정, Playwright 연계 수행 절차를 문서화. `README.md`, `docs/unit_test_workflow.md`, `docs/unit_test_rules.md`, `docs/common_checklist_master.md`에 Jest/Playwright 절차를 반영.
...
## 다음 작업
- Jest 전환 또는 신규 도입 대상 프로젝트와 기능을 지정
- `unit_test/reports/`에 첫 `DEV_TS_0003` 결과서 산출물 생성

## 실행 / 검증
- run_command: `N/A (docs and skill repository)`
- verify_command: `README.md`, `docs/javascript_jest_playwright_standard.md`, `docs/unit_test_workflow.md`, `docs/unit_test_rules.md`, `docs/common_checklist_master.md`, `SKILL.md` 확인
- port_or_runtime: `N/A`
...
- key_docs:
  ...
  - `D:\Workspace\unit_test\docs\javascript_jest_playwright_standard.md`
...
- 기존 프로젝트가 Vitest 등 다른 러너를 사용 중이면 사용자 승인 없이 Jest로 강제 교체하지 않는다.
