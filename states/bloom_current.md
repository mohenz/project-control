...
## 최근 완료 작업
- 2026-07-04: 대시보드 메인(`index.html`) 히어로 섹션 상단의 '인물 이미지 프롬프트를 조합하고 문장형/영문 결과를 생성하는 프리미엄 프롬프트 빌더 및 콘텐츠 아카이브입니다.' 안내 문구를 삭제.
...
## 핵심 경로
- project_root: `D:\workspace\bloom_universe`
- key_docs:
  - `README.md`
  - `.env.example`
