...
| `archive_store` | React/Vite 개인용 아카이브 웹앱 + local API + Firebase-ready 구조 | app `5174`, API `5175`, DB `54324` | Local PostgreSQL 18.4, local uploads, Firebase Auth/Firestore/Storage-ready | GitHub `mohenz/archive-store`, Firebase infra 진행 중 | `states/archive_store_current.md` |
