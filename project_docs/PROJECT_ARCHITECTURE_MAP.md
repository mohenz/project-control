...
| `memorybook` | React/Vite 메모·일정·자료실 프로그램 | Vite `localhost:3030` | Supabase Auth + `memo_states` JSONB + `archive_files` + 비공개 Storage/RLS | Vercel 구성 완료, 저장소·프로젝트 연결 대기 | `states/memorybook_current.md` |
