...
| `personalMemo` | `personalMemo`, `personal memo`, `personalmemo`, `personal notes`, `개인 메모`, `메모앱` | `D:\Workspace\personalMemo` | React/Vite + TypeScript personal note-taking app from Google AI Studio with Gemini API config | run: `npm.cmd run dev` / verify: `npm.cmd run build`, `npm.cmd run lint` / port: `3000` | `states/personalMemo_current.md` | `README.md`, `docs\codex_handover.md`, `.env.example`, `metadata.json`, `src\App.tsx`, `src\components\NoteEditor.tsx`, `src\components\NoteDetail.tsx` | GitHub: `https://github.com/mohenz/personalMemo.git`, deploy TBD |
